...
from defect_detection.constants import DEFAULT_DB_PATH
...
class _DefectDatabaseCore:
    ...
    def _create_tables(self):
        ...
        self.cursor.execute(
            "CREATE INDEX IF NOT EXISTS idx_bottles_timestamp ON bottles(timestamp)"
        )
    ...
    def insert_bottle(
        ...
        self.cursor.execute(
            "INSERT INTO bottles "
            "(id_bottle, display_id, session_id, production_lot, timestamp, status)"
            " VALUES (?, ?, ?, ?, ?, ?)",
    ...
    def get_defect_by_bottle_id(self, bottle_id: str) -> dict[str, Any] | None:
...
class DefectDatabase:
    ...
    def __init__(self, db_path: str = DEFAULT_DB_PATH):
        ...
        self._worker_thread = threading.Thread(
            target=self._worker_loop, daemon=True, name="DBWorker"
        )
    ...
    def insert_bottle(
        ...
        return self._execute(
            "insert_bottle", bottle_id, display_id, session_id, production_lot, status
        )
