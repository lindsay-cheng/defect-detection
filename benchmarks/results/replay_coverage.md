...
- crossing-detection rate: 5/5 = 1.000 CI (0.566, 1.000)
- correct-log rate (OK-good+OK-defect)/expected: 5/5 = 1.000 CI (0.566, 1.000)
- per-verdict proportions (n = expected = 5):
  - OK-good: 2/5 = 0.400 CI (0.118, 0.769)
  - OK-defect: 3/5 = 0.600 CI (0.231, 0.882)
  - FALSE-POSITIVE: 0/5 = 0.000 CI (0.000, 0.434)
  - MISS: 0/5 = 0.000 CI (0.000, 0.434)
  - WRONG-TYPE: 0/5 = 0.000 CI (0.000, 0.434)

## Label stability
- raw per-frame classes (raw_defect_type): mean stability 0.905, perfectly-stable 15/26 (57.7%) CI (0.389, 0.745)
- stabilized classes (defect_type):     mean stability 0.918, perfectly-stable 18/26 (69.2%) CI (0.500, 0.835)
