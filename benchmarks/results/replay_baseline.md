...
## Flicker Metrics
- total tracks: 24
- tracks with >1 class: 13 / 24 (54.2%)
- total class switches: 56
- switches within ±10 frames of crossing: 6
- per-track flicker timelines:
  - trk 1: good(x109) -> no_cap(x1) -> good(x10) -> no_cap(x1) -> good(x9) -> no_cap(x1) -> good(x3) -> no_cap(x1) -> good(x82)
  - trk 9: good(x11) -> no_label(x8) -> good(x7) -> no_label(x1) -> good(x3) -> no_label(x1) -> good(x1) -> no_label(x14) -> good(x1) -> no_label(x108) -> good(x2) -> no_label(x1) -> good(x7) -> no_label(x2) -> good(x2) -> no_label(x7) -> good(x1) -> no_label(x13) -> good(x3)
  - trk 10: no_label(x1) -> good(x11) -> no_label(x7) -> good(x1) -> no_label(x3) -> good(x1) -> no_label(x1) -> good(x7)
  - trk 15: good(x23) -> low_water(x172) -> good(x2) -> low_water(x9) -> good(x3) -> low_water(x3) -> good(x3)
  ...
  - trk 36: no_cap(x87) -> good(x2) -> no_cap(x95)
  - trk 38: good(x11) -> no_cap(x2)
